...
import DeleteCompany from "@/app/components/company/DeleteCompany";
...
// Page component
const Page = () => {
  // Use the useCompany hook to get context values
  ...
  const [actionType, setActionType] = useState(""); // Type of action (delete or switch)
  const [actionCompanyId, setActionCompanyId] = useState(""); // Company ID for the action
  // const history = useHistory(); // Create a history object

  // Initial company data with isActive property
  const [companies, setCompanies] = useState([
    { id: 1, name: "Velox Labs", isActive: true },
    { id: 2, name: "Biraj Ltd", isActive: false },
    // Add more companies as needed
  ]);

  // Handle deletion of a company
  const handleDelete = (companyId) => {
    // Set action details for confirmation dialog
    setActionType("delete");
    setActionCompanyId(companyId);
    setShowConfirmation(true);
  };

  // Handle switching the isActive state for a company
  ...
  // Handle tab click to switch between active and inactive companies
  ...
  // Handle confirmation dialog "Yes" click
